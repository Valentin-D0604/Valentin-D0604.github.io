...
<p className="text-lg leading-relaxed mb-6">
  ...
  et des météorites pour gagner des points ainsi que des power-ups 
  ...
  Les ennemis deviennent également plus forts avec l'augmentation des points.
</p>
<p className="text-lg leading-relaxed mb-6">
  Dans ce projet, j'ai pu m'occuper de toute la partie gameplay avec les déplacements et tirs du joueur, les power-ups et le fonctionnement des ennemis et des météorites. 
